...
class ChainCollectionCore(unittest.TestCase):
    ...
    def test_ChainCollection_input_exception_3(self):
        ...
        self.assertRaises(ValueError, ChainCollection, None, './tests/Data/NonExistentFile.fasta')
    ...
    def test_ChainCollection_input_exception_4(self):
        ...
        # it throws an error
        self.assertRaises(ValueError, ChainCollection, None, './tests/Data/__init__.py')
    ...
    def test_ChainCollection_load_fasta_exception(self):
        ...
        antibody_collection_1 = ChainCollection(path='./tests/Data/NotAFASTAFile.fasta')
    ...
    def test_ChainCollection_Hmatrix_calculation(self):
        antibody_collection_1 = ChainCollection(path='./tests/Data/chain_collection_fasta_test.fasta')
        antibody_collection_1.load(show_progressbar=False, verbose=False)
        # if this fails it means that abysis has been updated
        self.assertEqual(antibody_collection_1.hydrophobicity_matrix().shape, (1, 158))
    ...
    def test_Chain_abysis_parser(self):
        antibody = ChainCollection(path='./tests/Data/chain_collection_fasta_test.fasta', numbering_scheme='chothia')
    ...
    def test_Chain_abysis_parser_kabat(self):
        antibody = ChainCollection(path='./tests/Data/chain_collection_fasta_test.fasta', numbering_scheme='kabat')
        antibody.load(verbose=False, show_progressbar=False)
        self.assertEqual(antibody.numbering_table(as_array=True)[0][-1], '-')
    ...
    def test_ChainCollection_add(self):
        ...
        antibody_collection_1 = ChainCollection(path='./tests/Data/chain_collection_1_heavy.json')
        antibody_collection_1.load(show_progressbar=False, verbose=False)
        antibody_collection_2 = ChainCollection(path='./tests/Data/chain_collection_2_heavy.json')
    ...
    def test_ChainCollection_add_exception_1(self):
        # check if adding two ChainCollection objects with one sequence each
        # results in a ChainCollection object with two sequences
        antibody_chothia = ChainCollection(path='./tests/Data/chain_collection_fasta_test.fasta', numbering_scheme='chothia')
        antibody_chothia.load(show_progressbar=False, verbose=False)
        antibody_kabat = ChainCollection(path='./tests/Data/chain_collection_fasta_test.fasta', numbering_scheme='kabat')
